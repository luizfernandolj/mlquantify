...
mlQuantify was **heavily inspired by** `QuaPy <https://github.com/HLT-ISTI/QuaPy>`_, a leading library for quantification in Python, and by `scikit-learn <https://scikit-learn.org/stable/index.html>`_ for its simple, familiar interface and workflow design.
...
.. list-table::
   ...
   * - .. image:: /images/luth_junior.jpeg
     ...
     - **Luiz Fernando Luth Junior**  
       *(lead developer, architect & documentation)*
   * - .. image:: /images/maletzke.jpg
         :width: 120px
         :align: center
